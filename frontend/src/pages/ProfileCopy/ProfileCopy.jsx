...
import { Box, Typography, Grid, Avatar, Paper, Container, Button, FormControl } from '@material-ui/core';
            ...
            <Paper className={classes.paper}>
              <Grid container direction="row" justify="flex-start" alignItems="stretch" spacing={2}>
                <Grid item xs={6} sm={12} md={6} lg={6} xl={6}>
                  ...
                  <FormControl onSubmit={onSubmitImgHandler}>
                    <input
                      accept="image/*"
